...
class AutoencoderDenoiserTrainer(BaseTrainMulti):
    ...
    def test_epoch(self):
        ...
        # np.save('delta_train',delta_train)
        delta_train = np.load('delta_train.npy')
        ...
        joblib.dump(pipeline, 'pipeline_pca500_k1000_delta_novalid.pkl')
        ...
        for cur_epoch in test_loop:
            ...
            pipe_delta_batch = pipeline.steps[0][1].transform(pipe_delta_batch)
